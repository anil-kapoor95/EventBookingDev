                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                         ...
                         <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="form-group">
                                ...
                                <span class="help-block m-b-none" style="font-size:12px;"><?php __('voucher_discount_hint', false, true); ?></span>
                            </div><!-- /.form-group -->
                        </div><!-- /.col-md-3 -->
                        ...
                        <div class="col-lg-4 col-md-8 col-sm-8">
                        	<div class="form-group">
								...
								<select name="event_id[]" id="event_id" multiple="multiple" class="form-control select-item" data-placeholder="-- <?php __('lblAll'); ?> --" data-msg-required="<?php __('pj_field_required', false, true);?>">
									...
									{
										$event_title = $v['name'] !== '' ? stripslashes($v['name']) : '#' . $v['id'];
										$event_title .= ' | ' . date($tpl['option_arr']['o_date_format'], $v['event_start_ts']);
										?><option value="<?php echo $v['id']; ?>" <?php echo in_array($v['id'], $tpl['ve_arr']) ? ' selected="selected"' : '';?>><?php echo pjSanitize::html($event_title); ?></option><?php
									}
									?>
								</select>
							</div><!-- /.form-group -->
